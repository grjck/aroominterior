    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseTwitterAuthentication(
                consumerKey: "43766f03f549d51e5ccc7c693bfc8d0e",
                consumerSecret: "43766f03f549d51e5ccc7c693bfc8d0e");

            app.UseFacebookAuthentication(
                appId: "266670661364391",
                appSecret: "43766f03f549d51e5ccc7c693bfc8d0e");

            app.UseMicrosoftAccountAuthentication(
                clientId: "54dd67af-0b4d-483e-bed3-76cc3ef12415",
                clientSecret: "7PRFk5TYAWZBdR?eQAw-/4QrB.gJfpn7");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "1092840898365-2go78qgtvksk3fqhapnnvv72atf764m7.apps.googleusercontent.com",
                ClientSecret = "Lhu89cQi4jyLsu2vBBwzKeFd"
            });
        }
    }
}
